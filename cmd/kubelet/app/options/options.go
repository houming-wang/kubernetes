...
func AddKubeletConfigFlags(fs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.DurationVar(&c.ContainerGCPeriod.Duration, "container-gc-period", c.ContainerGCPeriod.Duration, "Period for performing container garbage collect.  Examples: '10s' or '1m'.")
